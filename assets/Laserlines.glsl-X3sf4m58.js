import{CJ as Le,CK as Ce,AQ as _,C7 as m,AP as F,Bv as V,AM as a,AJ as he,Bt as G,Aq as Me,i2 as ce,dy as h,eA as de,gJ as Ae,AW as ue,_ as pe,AY as _e,AZ as ge,A_ as fe,AU as me,g_ as $,B4 as Pe,Cd as Re,dU as o,jc as $e,dT as R,g$ as Te,BI as Oe,u9 as ze,h8 as Ie,h9 as qe,lb as be,E as f,AV as w,Ck as Be,nx as We,rg as N,CB as Ne,BW as M,dS as T,nv as k,em as ve,gI as P,gH as b,CL as xe,nN as He,dR as Ue,ke as we,ny as je,pI as Fe,kf as Ge,Bp as ke,na as X,ki as W,BC as Xe,nD as Ze,F as q,H as Je,BD as Ke,eE as Z,lB as J,CM as Qe,CN as O,CO as Ye,a5 as K,gZ as et,nI as tt,AC as it,nK as nt,nL as st,nM as rt,CP as at,km as Q,mg as Y,nG as ee,mo as te,CQ as lt,CR as ot,CS as ht,e0 as ct,dP as ie,tU as dt,v1 as ut,jt as pt,lc as ne,CT as _t,CU as gt}from"./index-VvDgqKaS.js";import{t as ft,a as mt}from"./LineVisualElement-CLLuWDoo.js";function Ee(t,e){const i=t.fragment;i.include(Le),t.include(Ce),i.uniforms.add(new _("globalAlpha",n=>n.globalAlpha),new m("glowColor",n=>n.glowColor),new _("glowWidth",(n,s)=>n.glowWidth*s.camera.pixelRatio),new _("glowFalloff",n=>n.glowFalloff),new m("innerColor",n=>n.innerColor),new _("innerWidth",(n,s)=>n.innerWidth*s.camera.pixelRatio),new F("depthMap",(n,s)=>{var r;return(r=s.linearDepth)==null?void 0:r.colorTexture}),new V("nearFar",(n,s)=>s.camera.nearFar),new F("frameColor",(n,s)=>s.mainColor)),i.code.add(a`vec4 blendPremultiplied(vec4 source, vec4 dest) {
...
}`),e}const Pt=de(),bt=Ae(),vt=Object.freeze(Object.defineProperty({__proto__:null,build:ye},Symbol.toStringTag,{value:"Module"}));class z extends _e{initializeProgram(e){return new ge(e.rctx,z.shader.get().build(this.configuration),De)}initializePipeline(){return fe({blending:me($.ONE,$.ONE_MINUS_SRC_ALPHA),colorWrite:Pe})}}z.shader=new ue(vt,()=>pe(()=>Promise.resolve().then(()=>$t),void 0));const De=new Map([[h.START,0],[h.END,1],[h.UP,2],[h.EXTRUDE,3]]);let se=class{constructor(e){this._renderCoordsHelper=e,this._buffers=null,this._origin=o(),this._dirty=!1,this._count=0,this._vao=null}set vertices(e){const i=$e(3*e.length);let n=0;for(const s of e)i[n++]=s[0],i[n++]=s[1],i[n++]=s[2];this.buffers=[i]}set buffers(e){if(this._buffers=e,this._buffers.length>0){const i=this._buffers[0],n=3*Math.floor(i.length/3/2);R(this._origin,i[n],i[n+1],i[n+2])}else R(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(e){const i=this._ensureVAO(e);i!=null&&(e.bindVAO(i),e.drawArrays(Te.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}_ensureVAO(e){return this._buffers==null?null:(this._vao==null&&(this._vao=this._createVAO(e,this._buffers)),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(e,i){const n=this._createDataBuffer(i);return this._dirty=!1,new Oe(e,De,{data:ze(ae)},{data:Ie.createVertex(e,qe.STATIC_DRAW,n)})}_ensureVertexData(e,i){var s;if(!this._dirty)return;const n=this._createDataBuffer(i);(s=e.vertexBuffers.data)==null||s.setData(n),this._dirty=!1}_numberOfRenderVertices(e){return 3*(2*(e.length/3-1))}_createDataBuffer(e){const i=e.reduce((u,c)=>u+this._numberOfRenderVertices(c),0);this._count=i;const n=ae.createBuffer(i),s=this._origin;let r=0,l=0;for(const u of e){for(let c=0;c<u.length;c+=3){const C=R(re,u[c],u[c+1],u[c+2]);c===0?l=this._renderCoordsHelper.getAltitude(C):this._renderCoordsHelper.setAltitude(C,l);const x=this._renderCoordsHelper.worldUpAtPosition(C,xt),d=r+2*c,j=be(re,C,s);if(c<u.length-3){n.up.setVec(d,x),n.up.setVec(d+3,x),n.up.setVec(d+5,x);for(let v=0;v<6;v++)n.start.setVec(d+v,j);n.extrude.setValues(d,0,-1),n.extrude.setValues(d+1,1,-1),n.extrude.setValues(d+2,1,1),n.extrude.setValues(d+3,0,-1),n.extrude.setValues(d+4,1,1),n.extrude.setValues(d+5,0,1)}if(c>0){n.up.setVec(d-2,x),n.up.setVec(d-4,x),n.up.setVec(d-5,x);for(let v=-6;v<0;v++)n.end.setVec(d+v,j)}}r+=this._numberOfRenderVertices(u)}return n.buffer}};const xt=o(),re=o(),ae=Re().vec3f(h.START).vec3f(h.END).vec3f(h.UP).vec2f(h.EXTRUDE);class H extends Be{constructor(){super(...arguments),this.contrastControlEnabled=!1}}f([w()],H.prototype,"contrastControlEnabled",void 0);const U=N(6);function Ve(t){const e=new he;e.include(Ne),e.include(Ee,t);const i=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(i.uniforms.add(new _("maxPixelDistance",(n,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(n.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(n.lineVerticalPlaneSegment.origin))),i.code.add(a`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const n=(r,l,u)=>P(r,l.heightManifoldTarget,u.camera.viewMatrix),s=(r,l)=>P(r,[0,0,0],l.camera.viewMatrix);i.uniforms.add(new M("heightManifoldOrigin",(r,l)=>(n(g,r,l),s(E,l),be(E,E,g),T(p,E),p[3]=k(E),p)),new m("globalOrigin",(r,l)=>s(g,l)),new _("cosSphericalAngleThreshold",(r,l)=>1-Math.max(2,ve(l.camera.eye,r.heightManifoldTarget)*l.camera.perRenderPixelRatio)/k(r.heightManifoldTarget))),i.code.add(a`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0, 0, 0, 0);`),t.heightManifoldEnabled){i.uniforms.add(new V("angleCutoff",s=>A(s)),new M("heightPlane",(s,r)=>Se(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,g),r.camera.viewMatrix)));const n=t.spherical?a`normalize(globalOrigin - pos)`:a`heightPlane.xyz`;i.code.add(a`
    {
      float heightManifoldAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, ${n})));
      vec4 heightManifoldColor = laserlineProfile(heightManifoldDistancePixels(heightPlane, pos));
      color = max(color, heightManifoldColor * heightManifoldAlpha);
    }
    `)}return t.pointDistanceEnabled&&(i.uniforms.add(new V("angleCutoff",n=>A(n)),new M("pointDistanceSphere",(n,s)=>wt(n,s))),i.code.add(a`{
float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
vec4 pointDistanceSphereColor = laserlineProfile(pointDistanceSphereDistance);
float pointDistanceSphereAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, normalize(pos - pointDistanceSphere.xyz))));
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);
}`)),t.lineVerticalPlaneEnabled&&(i.uniforms.add(new V("angleCutoff",n=>A(n)),new M("lineVerticalPlane",(n,s)=>Et(n,s)),new m("lineVerticalStart",(n,s)=>yt(n,s)),new m("lineVerticalEnd",(n,s)=>Dt(n,s))),i.code.add(a`{
...
}`)),t.intersectsLineEnabled&&(i.uniforms.add(new V("angleCutoff",n=>A(n)),new m("intersectsLineStart",(n,s)=>P(g,n.lineStartWorld,s.camera.viewMatrix)),new m("intersectsLineEnd",(n,s)=>P(g,n.lineEndWorld,s.camera.viewMatrix)),new m("intersectsLineDirection",(n,s)=>(b(p,n.intersectsLineSegment.vector),p[3]=0,T(g,xe(p,p,s.camera.viewMatrix)))),new _("intersectsLineRadius",n=>n.intersectsLineRadius)),i.code.add(a`{
